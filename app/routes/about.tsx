...
export default function AboutPage() {
  ...
  useEffect(() => {
    document.title = "আমাদের সম্পর্কে - বাংলা সংবাদ যাচাইকারী";
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "বাংলা সংবাদ যাচাইকারী সম্পর্কে জানুন। আমাদের দল, উদ্দেশ্য এবং AI চালিত ফ্যাক্ট চেকিং প্রযুক্তি সম্পর্কে বিস্তারিত তথ্য।"
      );
    } else {
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-text mb-2">
              বাংলা ফ্যাক্ট চেকার প্রকল্প সম্পর্কে
            </h1>
            <p className="text-xl text-text">
              About the Bengali Fact Checker Project
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-lg leading-relaxed text-text">
              ডিজিটাল মিডিয়ার মাধ্যমে তথ্যের প্রবেশাধিকার সময়ের সাথে দ্রুত
              বৃদ্ধি পাচ্ছে। এর ব্যাপক প্রবেশাধিকার এমন তথ্য ছড়ায় যা মানুষের
              মতামত গঠন করে এবং তাদের জীবনের পছন্দগুলিকে প্রভাবিত করে।
            </p>
            <p className="text-lg leading-relaxed text-text">
              The access to information through digital media is expanding
              rapidly with time. While this advancement helps people become more
              aware, it also holds the potential to mislead people through the
              spread of "fake news" and disrupt societal harmony across health,
              education, industry, and political sectors.
            </p>
            <div className="bg-card p-4 rounded-lg border-l-4 border-primary">
              <p className="text-text font-medium">
                <strong>Key Challenge:</strong> Bengali, despite being one of
                the most spoken languages globally with 256 million speakers,
                remains under-served by fact-checking tools due to its status as
          ...
          <CardContent className="space-y-4">
            <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
              <p className="text-gray-800 leading-relaxed">
                The proliferation of misinformation in rapidly growing digital
                media imposes a significant threat on public decision making and
                understanding, especially in low-resource and unexplored
                languages like Bengali. This leaves Bengali speakers vulnerable
                to the detrimental effects of misinformation.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-background">
                  In Bangladesh, the price of salt doubled due to a rumor of its
                  shortage in 2019, demonstrating the real-world consequences of
                  misinformation.
                </p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-background">
                  Existing studies lack appropriate datasets and exploration of
                  Large Language Models for state-of-the-art misinformation
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-text">
                  Curating a diverse collection of Bengali misinformation
                  instances from various digital media sources
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-text">
                  Testing Large Language Models including GPT-3.5-Turbo,
                  BanglaBERT, and Mistral-7B
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-text">
                  Developing a framework to improve misinformation detection in
          ...
          <CardContent className="space-y-4">
            <div className="bg-card p-6 rounded-lg border">
              ...
              <p className="text-text leading-relaxed mb-4">
                This research will support the fact-checking community in
                Bangladesh by providing necessary tools and resources to combat
                misinformation in Bengali. It addresses the critical gap in
                fact-checking systems for low-resource languages.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-card rounded-lg">
                  ...
                  <p className="text-sm text-text">
                    Protecting 256 million Bengali speakers from misinformation
                    across health, politics, and social media
                  </p>
                </div>
                <div className="bg-card rounded-lg">
                  <h4 className="font-semibold text-text mb-2">
                  ...
                  <p className="text-sm text-text">
                    Contributing to the advancement of fact-checking systems for
                    low-resource languages globally
                  </p>
                </div>
              </div>
            </div>
